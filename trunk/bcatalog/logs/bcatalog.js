function CityNav(cityListCnt, cityNavCnt){
...
/*
 function CityNav(cityListCnt, cityNavCnt, currCity, handleUrl){
...
CityNav.prototype.initCityNav = function(){

    var CityNavElt = this;

    this.cityNavCnt.find('span.city-list-trigger').bind('click', {ui:CityNavElt}, this.toggleCityList);
    this.cityListCnt.find('span.close').bind('click', {ui:CityNavElt}, this.toggleCityList);
}

CityNav.prototype.selectRegion = function(evtObj){
    //console.log('here');
    var clickedRegion = $(evtObj.target);
    var regions = evtObj.data.ui.cityListCnt.find('td.regions:last ul');
    var areas = evtObj.data.ui.cityListCnt.find('td.areas:last');
...
CityNav.prototype.selectArea = function(evtObj){
...
CityNav.prototype.selectCity = function(evtObj){
...
CityNav.prototype.showRegionCities = function(evtObj){
...
function BCatalog(container, searchCnt, cityNavCnt, cityListCnt, alphaNavCnt, bankListCnt, pageNavCnt, currCity, currBank, handler, bankUrl){
    ...
    CityNav.apply(this, new Array(cityListCnt, cityNavCnt, currCity));
...
var cityNavObj = new CityNav();
BCatalog.prototype = cityNavObj;
...
/**
 * прячет все элементы списка, которые не начинаются с заданной буквы
 * @param {jQqueryEvent} evtObj объект события jQuery
 *
BCatalog.prototype.alphaFilter = function(evtObj){
